...
from system_tools.config import TestsConfig
from system_tools.errors import CommandException
from system_tools.test_platform import PlatformsFactory


class TestMinHotPlug(BaseTest):
    def setUp(self):
        self.tests_config = TestsConfig()
        self.platforms_factory = PlatformsFactory(self.tests_config.cmd_sender_platform)
